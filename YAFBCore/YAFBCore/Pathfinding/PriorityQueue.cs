...
namespace YAFBCore.Pathfinding
{
    /// CREDITS TO BlueRaja
    ...
    public sealed class PriorityQueue: IEnumerable<MapSectionRasterTile>//IFixedSizePriorityQueue<T, float>
    {
        ...
        public PriorityQueue(int maxNodes)
        {
            ...
            _numNodes = 0;
            _nodes = new MapSectionRasterTile[maxNodes + 1];
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public bool Contains(MapSectionRasterTile node)
        {
#if DEBUG
            if (node == null)
            {
        ...
        /// O(log n)
        /// </summary>
        public void Enqueue(MapSectionRasterTile node, float priority)
        {
#if DEBUG
            if (node == null)
            {
        ...
        private void CascadeUp(MapSectionRasterTile node)
        {
            //aka Heapify-up
            int parent;
            if (node.QueueIndex > 1)
            {
                ...
                MapSectionRasterTile parentNode = _nodes[parent];
        ...
        /// </summary>
        /// <param name="node"></param>
        private void CascadeDown(MapSectionRasterTile node)
        {
            //aka Heapify-down
            ...
            MapSectionRasterTile childLeft = _nodes[childLeftIndex];
            if (HasHigherPriority(childLeft, node))
            {
                ...
                MapSectionRasterTile childRight = _nodes[childRightIndex];
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private bool HasHigherPriority(MapSectionRasterTile higher, MapSectionRasterTile lower)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private bool HasHigherOrEqualPriority(MapSectionRasterTile higher, MapSectionRasterTile lower)
        {
            return (higher.Priority <= lower.Priority);
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public MapSectionRasterTile Dequeue()
        {
#if DEBUG
            if (_numNodes <= 0)
            {
            ...
            MapSectionRasterTile returnMe = _nodes[1];
            ...
            MapSectionRasterTile formerLastNode = _nodes[_numNodes];
        ...
        public void Resize(int maxNodes)
        {
            ...
            MapSectionRasterTile[] newArray = new MapSectionRasterTile[maxNodes + 1];
            int highestIndexToCopy = Math.Min(maxNodes, _numNodes);
            Array.Copy(_nodes, 0, newArray, 0, highestIndexToCopy + 1);
            _nodes = newArray;
        }
        ...
        /// O(1)
        /// </summary>
        public MapSectionRasterTile First
        {
            get
            {
#if DEBUG
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public void UpdatePriority(MapSectionRasterTile node, float priority)
        {
#if DEBUG
            if (node == null)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        private void OnNodeUpdated(MapSectionRasterTile node)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public void Remove(MapSectionRasterTile node)
        {
#if DEBUG
            if (node == null)
            {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void ResetNode(MapSectionRasterTile node)
        {
#if DEBUG
            if (node == null)
            {
        ...
        public IEnumerator<MapSectionRasterTile> GetEnumerator()
        {
//#if NET_VERSION_4_5 // ArraySegment does not implement IEnumerable before 4.5
            IEnumerable<MapSectionRasterTile> e = new ArraySegment<MapSectionRasterTile>(_nodes, 1, _numNodes);
