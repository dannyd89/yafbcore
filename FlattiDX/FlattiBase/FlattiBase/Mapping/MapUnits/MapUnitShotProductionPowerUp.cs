...
namespace FlattiBase.Mapping.MapUnits
{
    ...
    public class MapUnitShotProductionPowerUp : MapUnit
    {
        public ShotProductionRefreshingPowerUp shotProductionRefreshingPowerUp;

        public MapUnitShotProductionPowerUp(FlattiBase.Screens.Screen screen, ShotProductionRefreshingPowerUp shotProductionRefreshingPowerUp, Vector movementOffset)
            : base(screen, shotProductionRefreshingPowerUp, movementOffset)
        {
            this.shotProductionRefreshingPowerUp = shotProductionRefreshingPowerUp;
        ...
        public override MapUnitKind Kind
        {
            get
            {
                return MapUnitKind.ShotProductionPowerUp;
            }
        }
        ...
        public override MapUnitMobility Mobility
        {
            get
            {
                return shotProductionRefreshingPowerUp.IsOrbiting ? MapUnitMobility.Steady : MapUnitMobility.Still;
            }
        }
        ...
        public override bool HasAging
        {
            get
            {
                return shotProductionRefreshingPowerUp.IsOrbiting;
            }
        }
