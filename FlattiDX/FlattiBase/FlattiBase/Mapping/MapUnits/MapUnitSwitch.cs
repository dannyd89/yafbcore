...
namespace FlattiBase.Mapping.MapUnits
{
    ...
    public class MapUnitSwitch : MapUnit
    {
        public Switch @switch;

        public MapUnitSwitch(FlattiBase.Screens.Screen screen, Switch @switch, Vector movementOffset)
            : base(screen, @switch, movementOffset)
        {
            this.@switch = @switch;
        }
        ...
        public override MapUnitMobility Mobility
        {
            get
            {
                return @switch.IsOrbiting ? MapUnitMobility.Steady : MapUnitMobility.Still;
            }
        }
