...
namespace FlattiBase.Mapping.MapUnits
{
    ...
    public class MapUnitPlanet : MapUnit
    {
        public Planet planet;

        public MapUnitPlanet(FlattiBase.Screens.Screen screen, Planet planet, Vector movementOffset)
            : base(screen, planet, movementOffset)
        {
            this.planet = planet;
        }
        ...
        public override MapUnitMobility Mobility
        {
            get
            {
                return planet.IsOrbiting ? MapUnitMobility.Steady : MapUnitMobility.Still;
            }
        }
