...
namespace FlattiBase.Mapping.MapUnits
{
    ...
    public class MapUnitEnergyPowerUp : MapUnit
    {
        public EnergyRefreshingPowerUp energyRefreshingPowerUp;

        public MapUnitEnergyPowerUp(FlattiBase.Screens.Screen screen, EnergyRefreshingPowerUp energyRefreshingPowerUp, Vector movementOffset)
            : base(screen, energyRefreshingPowerUp, movementOffset)
        {
            this.energyRefreshingPowerUp = energyRefreshingPowerUp;
        ...
        public override MapUnitKind Kind
        {
            get
            {
                return MapUnitKind.EnergyPowerUp;
            }
        }
        ...
        public override MapUnitMobility Mobility
        {
            get
            {
                return energyRefreshingPowerUp.IsOrbiting ? MapUnitMobility.Steady : MapUnitMobility.Still;
            }
        }
        ...
        public override bool HasAging
        {
            get
            {
                return energyRefreshingPowerUp.IsOrbiting;
            }
        }
        ...
        public override void Draw(SharpDX.Direct2D1.WindowRenderTarget renderTarget, Transformator X, Transformator Y)
        {
            ...
            //                            TextLayout,
            //                            SolidColorBrushes.BlueViolet, SharpDX.Direct2D1.DrawTextOptions.NoSnap);
        }
