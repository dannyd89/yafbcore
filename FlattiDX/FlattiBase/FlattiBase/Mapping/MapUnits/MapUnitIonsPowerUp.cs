...
namespace FlattiBase.Mapping.MapUnits
{
    ...
    public class MapUnitIonsPowerUp : MapUnit
    {
        public IonsRefreshingPowerUp ionsRefreshingPowerUp;

        public MapUnitIonsPowerUp(FlattiBase.Screens.Screen screen, IonsRefreshingPowerUp ionsRefreshingPowerUp, Vector movementOffset)
            : base(screen, ionsRefreshingPowerUp, movementOffset)
        {
            this.ionsRefreshingPowerUp = ionsRefreshingPowerUp;
        ...
        public override MapUnitKind Kind
        {
            get
            {
                return MapUnitKind.IonsPowerUp;
            }
        }
        ...
        public override MapUnitMobility Mobility
        {
            get
            {
                return ionsRefreshingPowerUp.IsOrbiting ? MapUnitMobility.Steady : MapUnitMobility.Still;
            }
        }
        ...
        public override bool HasAging
        {
            get
            {
                return ionsRefreshingPowerUp.IsOrbiting;
            }
        }
        ...
        public override void Draw(SharpDX.Direct2D1.WindowRenderTarget renderTarget, Transformator X, Transformator Y)
        {
            ...
            //g.DrawString(ionsRefreshingPowerUp.Name, GameField.FontTahomaSmall, Brushes.White, X[Position.X], Y[Position.Y]);
        }
