...
namespace FlattiBase.Mapping.MapUnits
{
    ...
    public class MapUnitHastePowerUp : MapUnit
    {
        public HastePowerUp hastePowerUp;

        public MapUnitHastePowerUp(FlattiBase.Screens.Screen screen, HastePowerUp hastePowerUp, Vector movementOffset)
            : base(screen, hastePowerUp, movementOffset)
        {
        ...
        public override MapUnitKind Kind
        {
            get
            {
                return MapUnitKind.HastePowerUp;
            }
        }
        ...
        public override void Draw(SharpDX.Direct2D1.WindowRenderTarget renderTarget, Transformator X, Transformator Y)
        {
            ...
            //                            TextLayout,
            //                            SolidColorBrushes.IndianRed, SharpDX.Direct2D1.DrawTextOptions.NoSnap);
        }
