...
namespace FlattiBase.Mapping.MapUnits
{
    ...
    public class MapUnitCloakPowerUp : MapUnit
    {
        public CloakPowerUp cloakPowerUp;

        public MapUnitCloakPowerUp(FlattiBase.Screens.Screen screen, CloakPowerUp cloakPowerUp, Vector movementOffset)
            : base(screen, cloakPowerUp, movementOffset)
        {
        ...
        public override MapUnitKind Kind
        {
            get
            {
                return MapUnitKind.CloakPowerUp;
            }
        }
        ...
        public override MapUnitMobility Mobility
        {
            get
            {
                return cloakPowerUp.IsOrbiting ? MapUnitMobility.Steady : MapUnitMobility.Still;
            }
        }
        ...
        public override bool HasAging
        {
            get
            {
                return cloakPowerUp.IsOrbiting;
            }
        }
        ...
        public override void Draw(SharpDX.Direct2D1.WindowRenderTarget renderTarget, Transformator X, Transformator Y)
        {
            ...
            //                            TextLayout,
            //                            SolidColorBrushes.LightGray, SharpDX.Direct2D1.DrawTextOptions.NoSnap);
        }
